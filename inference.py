...
sample_data = load_dataset('csv', data_files={'test': 'test.csv', }, data_dir='/Users/joseph/Desktop/Data/huggingface/datasets/downloads/extracted/c2137b76dc677adb64cbd000e78c4ff69c9ab84dafa95896f413dfd594a11d9e/cv-corpus-6.1-2020-12-11/ru/dataset')
...
tokenizer = Wav2Vec2CTCTokenizer("../vocabs/vocab_ru_clean.json", unk_token="[UNK]",
...
model = Wav2Vec2ForCTC.from_pretrained('../models/my_model')
...
test_dataset.save_to_disk('/Users/joseph/Desktop/Data/huggingface/datasets/downloads/extracted/c2137b76dc677adb64cbd000e78c4ff69c9ab84dafa95896f413dfd594a11d9e/cv-corpus-6.1-2020-12-11/ru/test')
...
print('\n---------------- Inferencing... ---------------------')
inputs = processor(test_dataset["speech"][:87], sampling_rate=16_000, return_tensors="pt", padding=True)  # .to(device)
with torch.no_grad():
...
references, predictions = same_length(predicted_sentences[:-1], test_dataset['sentence'][1:87])
...
num_of_sample_wer = 87
num_of_bad_sample_cer = 0
num_of_sample_cer = 87
