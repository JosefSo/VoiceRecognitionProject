...
tokenizer = Wav2Vec2CTCTokenizer("../checkpoint/vocab_20band.json", unk_token="[UNK]",
...
model = Wav2Vec2ForCTC.from_pretrained('../checkpoint/checkpoint-8416')
...
test_dataset.save_to_disk('/home/or/Desktop/arabic/current/test')
...
#     print("Prediction:", predicted_sentence)
#
#     result_cer = cer.compute(predictions=[predicted_sentence], references=[test_dataset[i+1]["sentence"]])
#     result_wer = wer.compute(predictions=[predicted_sentence], references=[test_dataset[i+1]["sentence"]])
#     print("WER: " + str(result_wer))
#     print("CER: " + str(result_cer))
#     results_cer.append(result_cer)
#     results_wer.append(result_wer)
