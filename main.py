...
# test = load_dataset("mozilla-foundation/common_voice_11_0", "pt", split="validation", use_auth_token=True)
...
training_args = TrainingArguments(
    ...
    num_train_epochs=10,
    fp16=True,
    save_steps=2286,  # change to num_of_samples / batch size to save on epoch
    eval_steps=100,
    logging_steps=10,
    learning_rate=3e-4,
    warmup_steps=500,
